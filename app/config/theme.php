...
return [
     ...
     */
    'views' => [
        ['region' => 'loginbar', 'template' => 'default/loginbar', 'data' => [], 'sort' => -1],
    
        ['region' => 'header', 'template' => 'default/header', 
            'data' => ['siteTitle' => "Allt om drönare",
                       'siteTagline' => "Frågor och svar om drönare",],
            'sort' => -1],
